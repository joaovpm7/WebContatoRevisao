...
public class ContatoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("acao").equals("editar")) {
            ...
            con.setId(Long.parseLong(idcont));
            con.setNome(nome);
            con.setSobrenome(sobrenome);
            con.setSexo(sexo);
            con.setDataNascimento(dataNascimento);
            con.setEmail(email);
            con.setDdd(ddd);
            con.setTelefone(telefone);
            con.setEscolaridade(escolaridade);
            boolean atualizou = con.Atualizar();
            if (atualizou) {
            ...
            int cont = Integer.parseInt(request.getParameter("idproduto"));
            Contato.Excluir(cont);
            String mensagem
